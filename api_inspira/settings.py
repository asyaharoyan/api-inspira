"""
Django settings for api_inspira project.
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'api_inspira.serializers.CurrentUserSerializer'
}
...
SECRET_KEY = 'django-insecure-4ti1n)w=0oa3=88jms!-nwq9z%rgtc@u5dd%$1q$oq%c1^ch)h'
